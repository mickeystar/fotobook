...
async	componentDidMount() {
	...
	//		const new_results = await fetchQuery(this.state.data);
			const new_results = await fetchQuery("");
			//console.log('new result:',new_results);
			//console.log('new result1:',new_results[0]);
			//console.log('new result size:', new_results.length);
			this.setState({imageTxID:new_results});
			//console.log("debug:"+this.state.imageTxID.length);
			this.setState( {image_num: "Result: " + new_results.length + " images"});
			//console.log(this.state.image_num);
	...
	//need to store all images then split out into pages and scroll infinite
	loadItems() {
		...
		//const new_results = this.state.imageTxID;
		...
		return (
			...
			>
				<div>
					<Carousel autoplay>
						<div>
							<h3 style={contentStyle1}>fotobook</h3>
						</div>
						<div>
							<h3 style={contentStyle2}>keep forever</h3>
						</div>
						<div>
							<h3 style={contentStyle3}>Upload Your Photos Now!</h3>
						</div>
					</Carousel>
...
//<h2>HELLO</h2>
//        <p>Welcome to fotobook.</p>
 
//        <p>Enjoy.</p>
		
//		<p>{this.state.image_num}</p>